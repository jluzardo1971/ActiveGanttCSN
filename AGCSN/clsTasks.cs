...
namespace AGCSN
{
    public class clsTasks : IEnumerable
	{
        ...
        internal clsTasks(ActiveGanttCSNCtl oControl)
		{
			...
			for (lIndex = 1; lIndex <= Count; lIndex++) 
			{
                ...
                if (oTask.Visible == true & oTask.InsideVisibleTimeLineArea == true) 
				{
					...
					if (mp_oControl.DrawEventArgs.CustomDraw == false) 
					{
                        ...
                        {
                            oTask.mp_lTextLeft = (int)mp_oControl.clsG.mp_oTextFinalLayout.Left;
                            oTask.mp_lTextTop = (int)mp_oControl.clsG.mp_oTextFinalLayout.Top;
                            oTask.mp_lTextRight = (int)mp_oControl.clsG.mp_oTextFinalLayout.Left + (int)mp_oControl.clsG.mp_oTextFinalLayout.Width - 1;
                            oTask.mp_lTextBottom = (int)mp_oControl.clsG.mp_oTextFinalLayout.Top + (int)mp_oControl.clsG.mp_oTextFinalLayout.Height - 1;
                        }
                        else
                        {
