...
namespace AGCSN
{
    public class ControlTemplateSolid
    {
        ...
        public Color HeadingBackColor = Color.FromArgb(255, 255, 255, 255);
        public Color TreeviewColor = Color.FromArgb(255, 100, 145, 204);
        public Color RowBorderColor = Color.FromArgb(255, 192, 192, 192);
        public Color TimeBlockBackColor = Color.FromArgb(255, 192, 192, 192);
    }
}