...
namespace AGCSN
{
    ...
    internal class clsMouseKeyboardEvents
    {
        ...
        internal clsMouseKeyboardEvents(ActiveGanttCSNCtl oControl)
        {
            mp_oControl = oControl;
            mp_oToolTip = new clsToolTip(mp_oControl);
        }

        internal void KeyDown(System.Windows.Forms.Keys KeyCode)
        {
        ...
        internal void KeyUp(System.Windows.Forms.Keys KeyCode)
        {
            mp_oControl.KeyEventArgs.Clear();
            mp_oControl.KeyEventArgs.KeyCode = KeyCode;
            mp_oControl.KeyEventArgs.Cancel = false;
        ...
        internal void OnMouseDown(int X, int Y, System.Windows.Forms.MouseButtons Button)
        {
        ...
        internal void mp_SetCursor(E_CURSORTYPE v_iCursorType)
        {
            switch (v_iCursorType)
            {
                ...
                case E_CURSORTYPE.CT_ROWHEIGHT:
                    ...
                    {
                        mp_oControl.Cursor = new System.Windows.Forms.Cursor(new System.IO.StreamReader(ai1.GetManifestResourceStream("AGCSN.HO_SPLIT.CUR")).BaseStream);
                        new System.IO.StreamReader(ai1.GetManifestResourceStream("AGCSN.HO_SPLIT.CUR")).Close();
                    }
                ...
                case E_CURSORTYPE.CT_COLUMNWIDTH:
                    ...
                    {
                        mp_oControl.Cursor = new System.Windows.Forms.Cursor(new System.IO.StreamReader(ai2.GetManifestResourceStream("AGCSN.VE_SPLIT.CUR")).BaseStream);
                        new System.IO.StreamReader(ai2.GetManifestResourceStream("AGCSN.VE_SPLIT.CUR")).Close();
                    }
                ...
                case E_CURSORTYPE.CT_MOVEROW:
                    ...
                    {
                        mp_oControl.Cursor = new System.Windows.Forms.Cursor(new System.IO.StreamReader(ai3.GetManifestResourceStream("AGCSN.DRAGMOVE.CUR")).BaseStream);
                        new System.IO.StreamReader(ai3.GetManifestResourceStream("AGCSN.DRAGMOVE.CUR")).Close();
                    }
                ...
                case E_CURSORTYPE.CT_MOVECOLUMN:
                    ...
                    {
                        mp_oControl.Cursor = new System.Windows.Forms.Cursor(new System.IO.StreamReader(ai5.GetManifestResourceStream("AGCSN.DRAGMOVE.CUR")).BaseStream);
                        new System.IO.StreamReader(ai5.GetManifestResourceStream("AGCSN.DRAGMOVE.CUR")).Close();
                    }
                ...
                case E_CURSORTYPE.CT_SCROLLTIMELINE:
                    ...
                    {
                        mp_oControl.Cursor = new System.Windows.Forms.Cursor(new System.IO.StreamReader(ai6.GetManifestResourceStream("AGCSN.C_WAIT05.CUR")).BaseStream);
                        new System.IO.StreamReader(ai6.GetManifestResourceStream("AGCSN.C_WAIT05.CUR")).Close();
                    }
                ...
                case E_CURSORTYPE.CT_PERCENTAGE:
                    ...
                    {
                        mp_oControl.Cursor = new System.Windows.Forms.Cursor(new System.IO.StreamReader(ai7.GetManifestResourceStream("AGCSN.PERCENTAGE.CUR")).BaseStream);
                        new System.IO.StreamReader(ai7.GetManifestResourceStream("AGCSN.PERCENTAGE.CUR")).Close();
                    }
                ...
                case E_CURSORTYPE.CT_PREDECESSOR:
                    ...
                    {
                        mp_oControl.Cursor = new System.Windows.Forms.Cursor(new System.IO.StreamReader(ai8.GetManifestResourceStream("AGCSN.PREDECESSOR.CUR")).BaseStream);
                        new System.IO.StreamReader(ai8.GetManifestResourceStream("AGCSN.PREDECESSOR.CUR")).Close();
                    }
