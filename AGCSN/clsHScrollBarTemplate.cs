...
namespace AGCSN
{
	...
	public class clsHScrollBarTemplate
	{
		...
		internal int Height = 17;
		internal int Width;
		internal int Top;
		internal int Left;
		private bool mp_bMouseDown = false;
		private int mp_iMouseXPosition;
        private E_BUTTON mp_iButton = E_BUTTON.BTN_NONE;
		private int mp_iTimerInterval = 100;
		private E_SCROLLSTATE mp_yState;
		private int mp_lValueBuff;
		private System.Timers.Timer mp_oTimer = new System.Timers.Timer();
        ...
        public clsHScrollBarTemplate(ActiveGanttCSNCtl oControl)
		{
            mp_oControl = oControl;
            ArrowButtons = new clsButtonState(mp_oControl, "Arrow");
            ThumbButton = new clsButtonState(mp_oControl, "Thumb");
            mp_oTimer.Elapsed += new System.Timers.ElapsedEventHandler(mp_oTimer_Tick);
		...
		internal void mp_oTimer_Tick(Object source, ElapsedEventArgs e)
		{
			switch (mp_iButton)
			{
