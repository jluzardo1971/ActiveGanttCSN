...
namespace AGCSN
{
    public class clsStyles : IEnumerable
	{
        ...
        internal clsStyles(ActiveGanttCSNCtl oControl)
        {
        ...
        internal void mp_ResetDefaultStyles()
        {
            ...
            mp_oDefaultColumnStyle.Font = (Font)mp_oControl.Configuration.DefaultFont.Clone();
            ...
            mp_oDefaultCellStyle.Font = (Font)mp_oControl.Configuration.DefaultFont.Clone();
        ...
        public bool ContainsKey(string Key)
        {
            ...
            {
                mp_oControl.mp_ErrorReport(SYS_ERRORS.STYLES_ADD_1, "Invalid Style object key, key cannot be numeric", "ActiveGanttCSNCtl.Styles.ContainsKey");
                return false;
            }
