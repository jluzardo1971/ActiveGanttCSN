...
namespace AGCSN
{
    internal partial class clsXML
    {
        ...
        internal clsXML(ActiveGanttCSNCtl oControl, String sObject)
        {
        ...
        internal void ReadProperty(String sElementName, ref System.Drawing.Color clrValue)
        {
            if (mp_bSupportOptional == false)
            {
                clrValue = ColorTranslator.FromOle(System.Convert.ToInt32(ParentElement().GetElementsByTagName(sElementName).Item(0).InnerText));
            }
            else
            {
                if (ParentElement() == null)
        ...
        internal void WriteProperty(String sElementName, System.Drawing.Color clrValue)
        {
            System.Xml.XmlElement oNodeBuff = null;
            oNodeBuff = xDoc.CreateElement(sElementName);
            oNodeBuff.InnerText = System.Convert.ToString(ColorTranslator.ToOle(clrValue));
            ParentElement().AppendChild(oNodeBuff);
        }
        ...
        internal void ReadProperty(String sElementName, ref Font oFont)
        {
            ...
            Font oFontBuff = new Font(sName, fSize, iStyle);
        ...
        internal void WriteProperty(String sElementName, ref Image oImage)
        {
            ...
            if (oImage != null)
            {
                ...
                String data;
                oImage.Save(mem, ImageFormat.Png);
