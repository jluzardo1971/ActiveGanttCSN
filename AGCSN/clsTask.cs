...
namespace AGCSN
{
	public class clsTask : clsItemBase
	{
        ...
        public clsTask(ActiveGanttCSNCtl oControl)
		{
		...
		public string RowKey 
		{
			...
			set 
			{
				...
				{
                    mp_oControl.mp_ErrorReport(SYS_ERRORS.INVALID_ROW_KEY, "Invalid Row Key (\"" + value + "\")", "ActiveGanttCSNCtl.clsTask.Let RowKey");
					return;
				}
				mp_sRowKey = value;
