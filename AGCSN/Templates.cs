...
namespace AGCSN
{
    static class Templates
    {
        ...
        public static void g_ApplyTemplate(ActiveGanttCSNCtl oControl, E_CONTROLTEMPLATE yControlTemplate, E_OBJECTTEMPLATE yObjectTemplate)
        {
        ...
        private static void mp_ControlTemplateSelector(ActiveGanttCSNCtl oControl, E_CONTROLTEMPLATE yControlTemplate)
        {
        ...
        private static void mp_ObjectTemplateSelector(ActiveGanttCSNCtl oControl, E_OBJECTTEMPLATE yObjectTemplate)
        {
        ...
        private static void mp_ApplyObjectTemplate(ActiveGanttCSNCtl oControl, S_ObjectTemplate oTemplate)
        {
        ...
        public static void g_ApplyTemplate_Gradient(ActiveGanttCSNCtl oControl, ControlTemplateGradient oTemplate, E_OBJECTTEMPLATE yObjectTemplate)
        {
            oControl.Styles.Clear();
            mp_ApplyControlTemplate_Gradient(oControl, oTemplate);
            mp_ObjectTemplateSelector(oControl, yObjectTemplate);
        ...
        private static void mp_ApplyControlTemplate_Gradient(ActiveGanttCSNCtl oControl, ControlTemplateGradient oTemplate)
        {
            clsStyle oStyle = null;
            ...
            oStyle.Font = new Font(oControl.Configuration.DefaultFont.FontFamily, 8, FontStyle.Bold);
            oStyle.Appearance = E_STYLEAPPEARANCE.SA_FLAT;
            ...
            oStyle.Font = new Font(oControl.Configuration.DefaultFont.FontFamily, 7, FontStyle.Regular);
            oStyle.Appearance = E_STYLEAPPEARANCE.SA_FLAT;
            ...
            oStyle.Font = new Font(oControl.Configuration.DefaultFont.FontFamily, 8, FontStyle.Regular);
            oStyle.Appearance = E_STYLEAPPEARANCE.SA_FLAT;
            oStyle.BackColor = Color.FromArgb(255, 255, 255, 255);
        ...
        public static void g_ApplyTemplate_Solid(ActiveGanttCSNCtl oControl, ControlTemplateSolid oTemplate, E_OBJECTTEMPLATE yObjectTemplate)
        {
            oControl.Styles.Clear();
            mp_ApplyControlTemplate_Solid(oControl, oTemplate);
            mp_ObjectTemplateSelector(oControl, yObjectTemplate);
        ...
        private static void mp_ApplyControlTemplate_Solid(ActiveGanttCSNCtl oControl, ControlTemplateSolid oTemplate)
        {
            clsStyle oStyle = null;
